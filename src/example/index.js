...
class Example extends Component {
  ...
  handleChange = boxes => container => {
    this.setState({
      ...
      localStorage.setItem(boxes, JSON.stringify(container.boxes))
    })
  }
